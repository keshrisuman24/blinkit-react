...
const Header = (props) => {
  ...
  return (
    <div className="h-[90px] fixed top-0 left-0 w-full z-10  bg-white flex border-b border-gray-200 z-10">
      ...
      <div className="w-5.5/12 flex justify-center items-center">
        <div className="h-[44px] w-[95%] bg-gray-100 border border-1 rounded-lg flex flex-row justify-center items-center">
          <img
      ...
      <div className="w-2.5/12 flex justify-around items-center">
        ...
        <div
          ...
          className="h-[50px] w-[100px] rounded-lg bg-buttonGreen flex flex-row justify-center items-center cursor-pointer"
        >
          <img
