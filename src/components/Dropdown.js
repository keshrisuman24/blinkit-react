...
const SortDropdown = () => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          className="absolute right-0 mt-2 w-[200px] rounded-sm shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10"
          role="menu"
          ...
          <div className="py-1">
            {options.map((option, index) => (
              <button
                ...
                className="font-poppins text-[12px] block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100"
                role="menuitem"
              >
                {option}
              </button>
